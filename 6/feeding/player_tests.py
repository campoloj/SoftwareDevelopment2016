...
class TestPlayer(unittest.TestCase):
    ...
    def test_next_feeding(self):
        ...
        self.assertEqual(Player.next_feeding(self.player_1, 10, [self.player_2, self.player_3]), [self.species_5, 3])
        # Test if hungry_herbivores
        self.species_5.traits = []
        self.assertEqual(Player.next_feeding(self.player_1, 10, [self.player_2]), self.species_6)
