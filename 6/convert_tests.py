...
class TestConvert(unittest.TestCase):
    ...
    def test_feeding_to_json(self):
        self.assertEqual(Convert.feeding_to_json(self.feed_1), self.json_feed_1)
        self.assertEqual(Convert.feeding_to_json(self.feed_2), self.json_feed_2)
        self.assertEqual(Convert.feeding_to_json(self.feed_3), self.json_feed_3)
        self.assertEqual(Convert.feeding_to_json(self.feed_4), self.json_feed_4)
